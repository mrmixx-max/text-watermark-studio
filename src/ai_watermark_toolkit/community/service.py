...
class CommunityService:
    ...
    def _save_communities(self, data):
        self.communities_path.write_text(json.dumps(data, ensure_ascii=False, indent=2), encoding="utf-8")

    def _load_communities(self):
        return json.loads(self.communities_path.read_text(encoding="utf-8"))
