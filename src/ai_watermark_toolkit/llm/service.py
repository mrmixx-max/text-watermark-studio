...
class LocalLLMService:
    ...
    def _ollama(self, path: str, method: str = "GET", payload: dict | None = None, timeout: int = 30):
        import urllib.error
        ...
        try:
            ...
            raise RuntimeError(f"ollama_{path.lstrip('/').replace('/', '_')}_failed: HTTP {e.code} {e.reason}") from e
