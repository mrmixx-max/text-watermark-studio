...
def process_batch(input_dir: str, output_dir: str, *, mode: str = 'pipeline', intensity: str = 'standard', lang: str = 'auto',
                  key_id: str | None = None, level: str = 'word', context: int = 1,
                  gamma: float | None = None, seed: int | None = None,
        ...
        try:
            ...
            if mode == 'detect':
                ...
                if verify:
                    ...
                    det = detect_kgw(result['text'], embed_key['secret'],
                                     gamma=effective_gamma, level=level,
                                     context=context)
                ...
                changed = out != text
            items.append(BatchItemResult(str(src), str(dst), mode, changed,
