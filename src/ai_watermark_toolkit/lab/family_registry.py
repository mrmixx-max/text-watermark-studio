...
FAMILIES = [
    ...
    FamilySpec('sampling_bias', 'Sampling / Logit Bias (post-hoc text-rewrite approximation)', 'editing_time', 'invisible', 'medium', 'keyed', ['decoder_control', 'key_material'], 'Green-list/red-list KGW applied as post-hoc text rewrite — no generation-time logit control (audit 2026-08-13).'),
