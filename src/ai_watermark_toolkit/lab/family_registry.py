...
FAMILIES = [
    ...
    FamilySpec('sampling_bias', 'Sampling / Logit Bias', 'generation_time', 'invisible', 'medium', 'keyed', ['decoder_control', 'key_material'], 'Green-list, red-list, bias and permutation style schemes.'),
